...
var clipboard = new ClipboardJS('.share-modal-link');
  clipboard.on('success', function(e) {
    ...
    document.getElementById("clipboard-link-feedback").innerHTML = '<span class="text-success font-weight-bold" style="position: absolute;right: 1rem;top: .5rem;z-index:3">Copied!</span>';
    console.log(e);
  });
